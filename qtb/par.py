...
class ParamSpace(ParamSpaceBase):
    ...
    def dgR1(self, iXi, iTheta):
        ...
        self.dpzgR1 = (self.compData['2'][iXi, start] -
                       self.compData['2'][iXi, finish]) / self.lim.dKPolar
        self.dpzgR1 /= -self.lim.v
        self.dpzgR1 *= np.sin(self.kPol[iXi])
